...
const translations = {
  en: {
    ...
    btn_switch_signup: "New learner? Create account",
  ...
  es: {
    ...
    btn_switch_signup: "¿Nuevo estudiante? Crear cuenta",
  ...
  hi: {
    ...
    btn_switch_signup: "नए शिक्षार्थी? खाता बनाएं",
  ...
  fr: {
    ...
    btn_switch_signup: "Nouvel apprenant ? Créer un compte",
...
function setAuthMode(mode) {
  ...
  // Hide/show signup-only fields first
  $("nameLabel").classList.toggle("hidden", !signup);
  $("signupFields").classList.toggle("hidden", !signup);
  // Apply language for other elements
  applyLanguage(state.lang);
  // Now apply auth-specific texts AFTER applyLanguage so they don't get overwritten
  const dict = translations[state.lang] || translations.en;
  if (signup) {
    $("authTitle").textContent = dict.auth_title;
    $("authSubmit").textContent = dict.btn_create;
    $("authSwitch").textContent = dict.btn_switch;
  } else {
    $("authTitle").textContent = dict.auth_title_signin || "Welcome Back";
    $("authSubmit").textContent = dict.btn_signin || "Sign in";
    $("authSwitch").textContent = dict.btn_switch_signup || "New learner? Create account";
  }
}
